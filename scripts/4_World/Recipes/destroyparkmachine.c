class destroyparkmachine extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismantle";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"GRMODPMACHINE");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("GarageMod_ParkingMachineKit");//add results here
